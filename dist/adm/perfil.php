...
<body>
  ...
  <main class="flex flex-col px-16 py-8 gap-8 self-stretch items-start justify-start w-full h-max font-poppins lg:h-screen">
    ...
    <section class="flex flex-row gap-8 self-stretch items-start justify-start w-full h-max font-poppins">
      <section class="flex flex-col w-full">
        <header>
          <h1 class="font-semibold text-4xl">Meu Perfil</h1>
        </header>
        <section class="card flex flex-col w-full h-full bg-vermelho rounded-3xl">
          <section class="content flex flex-col bg-vermelho px-16 py-8 text-white rounded-3xl w-full">
