...
<body>
  ...
  <main class="flex flex-col px-16 py-8 gap-8 self-stretch items-center justify-center w-full">
    <section class="flex flex-row items-center justify-center w-full font-poppins text-2xl gap-[1.875rem]">
      ...
      <section class="flex flex-col justify-center items-start p-[1.25rem] gap-2 bg-white shadow-lg w-full h-3/4">
        <header class="flex flex-row font-poppins gap-2.5 items-center">
          <h1 class="text-[2rem] font-semibold">Ação Selecionada</h1>
          <p>Novo Socorrista</p>
        </header>
        <section class="flex flex-col actions gap-2 w-full">
          <form class="flex flex-col gap-2.5 w-full max-h-[18rem] font-poppins overflow-y-scroll" action="" method="">
            ...
            <div class="input_box flex flex-col gap-2.5" title="Input Box">
              ...
              <div id="admin" class="container_radio flex flex-row items-center gap-10">
                <div class="flex items-center gap-2.5">
                  <input type="radio" id="adm_sim_desktop" name="escolha" value="sim" class="appearance-none w-5 h-5 border border-input_placeholder checked:bg-vermelho rounded-full">
                  <label for="adm_sim_desktop" class="text-xl">Sim</label>
                </div>
                <div class="flex items-center gap-2.5">
                  <input type="radio" id="adm_nao_desktop" name="escolha" value="nao" class="appearance-none w-5 h-5 border border-input_placeholder checked:bg-vermelho rounded-full">
            ...
            <div id="adm_code_container" class="input_box hidden flex-col g-2.5" title="Input Box">
              ...
              <input id="adm_code_desktop" type="password" class="input border-b-2 border-[#595959] p-3 bg-input_color text-input_placeholder text-sm 
    ...
    <section aria-label="Lista de Socorristas e Médicos" title="Cadastros" class="flex justify-center items-start gap-10 self-stretch">
      <section aria-labelledby="title_socorristas" class="socorristas flex flex-col gap-5" title="Socorristas Cadastrados">
        <header>
        ...
        <div class="input_box flex flex-row items-center gap-2.5 w-full" title="Input Box">
          ...
          <input id="buscar" type="text" class="font-poppins input w-full border-b-2 border-[#595959] p-3 bg-input_color text-input_placeholder text-sm 
      ...
      <section aria-labelledby="title_medicos" class="medicos flex flex-col gap-5" title="Médicos Cadastrados">
        <header>
  ...
  <footer class="flex flex-col justify-center items-start gap-[0.625rem] w-full h-full self-stretch bg-white
    desktop:flex-col desktop:items-start
  ">
    ...
    ">
      <section class="logos_row flex flex-row justify-center items-center gap-4 self-stretch">
        <img src="../../public/images/logo-noar.png" alt="Logo Noar">
        <img src="../../public/images/ambulancia.png" alt="Logo Ambulância">
      ...
      <header aria-labelledby="footer_title_mobile" class="header flex desktop:hidden flex-col justify-center items-start gap-2.5 self-stretch">
        ...
        <p class="self-stretch text-cinza font-poppins text-xl font-normal leading-5 w-fill">
          Fazendo uso da <b>tecnologia</b> para <b>otimizar</b> o atendimento de ocorrências e facilitar a <b>comunicação</b> entre bombeiros e médicos
        </p>
      </header>
