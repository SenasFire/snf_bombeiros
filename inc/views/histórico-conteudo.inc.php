...
<section class="form-container flex flex-col items-center justify-center md:w-full tablet:w-full">
    <form class="flex flex-col gap-8 font-poppins" action="../inc/class/cadastrar_historico.class.php">
        ...
        <section class="flex flex-col gap-2.5">
            ...
            <section class="flex flex-col laptop:flex-row gap-4 laptop:gap-10 desktop:gap-20">
                <section class="flex flex-col gap-4">
                    ...
                    <section class="flex flex-col gap-4 tablet:flex-row md:p-3 md:gap-10">
                        <section class="flex flex-col gap-4">
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Membro Inferior Direito." type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Membro Inf. Dir. </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Membro Inferior Esquerdo." type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Membro Inf. Esq. </span>
                    </div>
                     <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Membro Superior Direito" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Membro Sup. Dir. </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Membro Superior Esquerdo" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Membro Sup. Esq. </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[] value="Quadril" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Quadril </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Cervical" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Cervical </span>
                    </div>
                    </section>
                    </section>
                    <div class="flex items-center gap-4 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Maca sobre rodas" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Maca sobre rodas </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Maca Rígida" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Maca rígida </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Ponte" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Ponte </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Retirado Capacete" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                ...
                <section class="flex flex-col gap-4 desktop:border-l-2 border-[#595959] desktop:px-10">
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="R.C.P" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> R.C.P </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkbox[]" value="Rolamento 90°C" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Rolamento 90°C </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Rolamento 180°C" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Rolamento 180°C </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Tomada decisão" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Tomada decisão </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Tratado Choque" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Tratado choque </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Uso de Cânula" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Uso de cânula </span>
                    </div>
                    <div class="flex items-center gap-2">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Uso Colar" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                    ...
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Uso KED" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Uso KED </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Uso TIF" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Uso TIF </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Ventilação Suporte" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                        <span class="text-gray-700"> Ventilação Suporte </span>
                    </div>
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Oxigênioterapia" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                    ...
                    <div class="input_box flex flex-col g-2.5" title="Input Box">
                        ...
                        <input name="Seleção_de_Imobilização" id="input_name" type="text" class="input border-b-2 border-[#595959] p-3 bg-input_color text-input_placeholder text-sm 
                    ...
                    <div class="flex items-center gap-2 ">
                        <input name="Seleção_de_Imobilização_checkout[]" value="Reanimador" type="checkbox" class="form-checkbox h-7 w-7 text-blue-500 border-gray-300 rounded focus:ring-blue-400">
                    ...
                    <legend class="font-bold text-xl text-row tablet:text-1xl ">Selecione os meios auxiliares da ocorrência (Polícia, Defesa Civil, ...)</legend>
            ...
            <!-- Área de seleção par a Materiais Ultilizados Descartáveis -->
      ...
      <header class="flex flex-col justify-center items-center gap-3 self-stretch text-center last:pb-2 last:border-b-2 last:border-[#595959]">
        <h1 id="title_main"  class="font-bold text-3xl">Materiais Utilizados<span class="text-vermelho"> Descartáveis</span></h1>
    ...
    <!-- FORM: -->
    <section class="form-container flex flex-col items-center justify-center md:w-full tablet:w-full">
      <form action="" class="flex flex-col items-center justify-center mx-10 gap-3 odd:bg-white even:bg-[#F2F2F2] w-full">
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full bg-[#F2F2F2]">
        ...
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Area_Selecao_Materias_Ultilizados_Descatarveis" id="num_fibra" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
        ...
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full bg-[#F2F2F2]">
          ...
          <select name="Area_Selecao_Materias_Ultilizados_Descartaveis" id="">
            <option value="None" disabled selected>Selecione...</option>
        ...
        <h1 id="title_main"  class="font-bold text-3xl">Materiais Utilizados<span class="text-vermelho"> na Ocorrência</span></h1>
        <p id="subtitle"     class="text-cinza text-sm text-center">Selecione as opções abaixo de acordo com a sua <b>necessidade.</b></p>
        <p id="instructions" class="text-cinza text-sm text-center">Você pode <b>adicionar</b> clicando nos botões, ou <b>adicioná-los diretamente</b> clicando na caixa de texto.</p>
      </form>
    </section>
    <section class="form-container flex flex-col items-center justify-center md:w-full tablet:w-full">
      <form action="" class="flex flex-col items-center justify-center mx-10 gap-3 odd:bg-white even:bg-[#F2F2F2] w-full">
        ...
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra1" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full bg-[#F2F2F2]">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra2" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra3" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full bg-[#F2F2F2]">
          <label for="id1">KED</label>
          <select name="Lista_Materias_Ultilizados_Ocorrencia" id="">
            <option value="None" disabled selected>Selecione...</option>
            <option value="Nenhum">Nenhum</option>
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra4" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra5" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full bg-[#F2F2F2]">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input id="num_fibra6" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra7" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full bg-[#F2F2F2]">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra8" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full">
          ...
          <div class="flex flex-row justify-end w-1/2">
            <input name="Lista_Materias_Ultilizados_Ocorrencia" id="num_fibra9" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        <div class="input-box flex flex-row justify-between items-center px-8 py-4 w-full bg-[#F2F2F2]">
          <label for="id1">Base do Estabilizador</label>
          <div class="flex flex-row justify-end w-1/2">
            <inpu name="Lista_Materias_Ultilizados_Ocorrencia"t id="num_fibra10" type="number" class="text-center input border-b-2 border-[#595959] w-1/2 bg-white text-input_placeholder text-sm
              transition ease-in-out focus:scale-105 focus:text-black focus:outline-vermelho focus:bg-white" placeholder="0">
          </div>
        </div>
        ...
        <div class="input-box flex flex-row justify-center items-start px-8 py-4 w-full gap-5" title="Outro material">
          ...
          <legend class="font-bold text-xl text-row tablet:text-3xl ">Observações Importantes</legend>
            <textarea name="Observacoes_Importantes" id="" cols="30" rows="10" class="text-center input border-b-2 border-[#595959] w-full bg-input_color text-input_placeholder text-sm
