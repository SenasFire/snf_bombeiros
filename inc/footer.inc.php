...
<footer class="flex flex-col justify-center items-start gap-[0.625rem] w-full h-full self-stretch p-8 bg-white">
  ...
  <section class="container_footer flex flex-col justify-center items-center gap-5 self-stretch">
    ...
    <!-- NAVEGAÇÃO: -->
    <section aria-labelledby="navegar_title" class="group_1 flex flex-col items-center gap-2.5">
      <h1 id="navegar_title" class="font-poppins font-bold leading-10 text-[2.5rem] text-preto"></h1>
      <ul class="flex flex-col text-cinza font-poppins font-normal leading-5">
        <li>Principal</li>
        <li>Login</li>
        <li>Ocorrências</li>
        <li>Dados</li>
    ...
    <!-- CONTATO: -->
    <section class="contato flex flex-col items-center gap-2.5 self-stretch">

      <h1 id="navegar_title" class="font-poppins font-bold leading-10 text-[2.5rem] text-preto">Contato</h1>
      <ul class="flex flex-col text-cinza font-poppins font-normal leading-5">
